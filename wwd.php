        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div  class="col-lg-6 full beige">
                    <h5>Firestarter Retreat</h5>
                    <p>
                        The Firestarter Retreat is held at the beginning of each semester. It is a time to "kick- off" the semester and start diving into the curriculum as well as really growing as a community.
                    </p>
                </div>
                ...
                <div  class="col-lg-6 full beige">
                    <h5>PuriFridays</h5>
                    <p>
                        PuriFridays give the students a chance to plan, create, and execute a bible study all from scratch. This process really challenges the students to work on public speaking, self study of the Word, communication, and a whole lot more. We really begin to sharpen and uncover the gifts that God has given us.
                    </p>
                </div>
                <div  class="col-lg-12 full brown">
